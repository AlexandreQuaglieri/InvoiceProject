...
// Détail d'un devis : lit le store live (useLiveQuote) — les mutations
// (statut, conversion) sont réconciliées sans aucune actualisation.
...
import { useLiveQuote, useLiveCompany } from '@/lib/realtime'
...
export function QuoteDetailContent({ id }: { id: string }) {
